...
#파일 이름과 데이터
bfilename = 'D:/6_PWork/5_inflearn/01_Python_Automation_and_GUI/Section4/test.bin'
tfilename = 'D:/6_PWork/5_inflearn/01_Python_Automation_and_GUI/Section4/test.txt'
